...
//         await web3.eth.sendTransaction({to: oracle.address,from:accounts[0],gas:7000000,data:oracle2.methods.requestData(api,0,0).encodeABI()});
//         logMineWatcher = await promisifyLogWatch(oracle2, 'NewValue');//or Event Mine?
//         await web3.eth.sendTransaction({to: oracle.address,from:accounts[2],gas:7000000,data:oracle2.methods.requestData(api,0,1).encodeABI()});  
//         data = await oracle.getVariablesOnQ();
//         assert(data[0] == 0, 'There should be no API on Q');
//         var vars = await oracle.getVariables();
//         assert(vars[1] == 1, "miningApiId should be 1");
//         await web3.eth.sendTransaction({to: oracle.address,from:accounts[2],gas:7000000,data:oracle2.methods.requestData(api2,0,5).encodeABI()});  
//         data = await oracle.getVariablesOnQ();
//         assert(data[0] == 2, "API on q should be #2");
//         await web3.eth.sendTransaction({to: oracle.address,from:accounts[2],gas:7000000,data:oracle2.methods.requestData(api,0,6).encodeABI()});
//         data = await oracle.getVariablesOnQ();
...
//         }
//         await web3.eth.sendTransaction({to: oracle.address,from:accounts[2],gas:7000000,data:oracle2.methods.requestData(api,0,11).encodeABI()});
//         logMineWatcher = await promisifyLogWatch(oracle2, 'NewValue');
//         res = web3.eth.abi.decodeParameters(['uint256','uint256','uint256'],logMineWatcher.data)
...
//             await web3.eth.sendTransaction({to: oracle.address,from:accounts[2],gas:7000000,data:oracle2.methods.requestData(apix,0,i).encodeABI()});
//         }
//         await web3.eth.sendTransaction({to: oracle.address,from:accounts[2],gas:7000000,data:oracle2.methods.requestData(api2,0,21).encodeABI()});
//         logMineWatcher = await promisifyLogWatch(oracle2, 'NewValue');
//         res = web3.eth.abi.decodeParameters(['uint256','uint256','uint256'],logMineWatcher.data)
//         data = await oracle.isData(1,res[1]);
//         assert(data == true, "Should be true if Data exist for that point in time");
...
//             await web3.eth.sendTransaction({to: oracle.address,from:accounts[2],gas:7000000,data:oracle2.methods.requestData(apix,0,i).encodeABI()});
//         }
//         await web3.eth.sendTransaction({to: oracle.address,from:accounts[2],gas:7000000,data:oracle2.methods.requestData(api,0,31).encodeABI()});
//         logMineWatcher = await promisifyLogWatch(oracle2, 'NewValue');
//         res = web3.eth.abi.decodeParameters(['uint256','uint256','uint256'],logMineWatcher.data)
//         data = await oracle.isData(2,res[1]);
//         assert(data == true, "Should be true if Data exist for that point in time");
...
//             await web3.eth.sendTransaction({to: oracle.address,from:accounts[2],gas:7000000,data:oracle2.methods.requestData(apix,0,i).encodeABI()});
//         }
//         await web3.eth.sendTransaction({to: oracle.address,from:accounts[2],gas:7000000,data:oracle2.methods.requestData(api2,0,41).encodeABI()});
//         logMineWatcher = await promisifyLogWatch(oracle2, 'NewValue');
//         res = web3.eth.abi.decodeParameters(['uint256','uint256','uint256'],logMineWatcher.data)
//         data = await oracle.isData(1,res[1]);
//         assert(data == true, "Should be true if Data exist for that point in time");
...
//             await web3.eth.sendTransaction({to: oracle.address,from:accounts[2],gas:7000000,data:oracle2.methods.requestData(apix,0,i).encodeABI()});
//         }
//         await web3.eth.sendTransaction({to: oracle.address,from:accounts[2],gas:7000000,data:oracle2.methods.requestData(api,0,56).encodeABI()});
